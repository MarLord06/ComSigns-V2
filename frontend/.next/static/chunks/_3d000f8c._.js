(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_3d000f8c._.js", {
...
function GamePage() {
    ...
    const [lives, setLives] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(5);
    ...
    const [wordsCompleted, setWordsCompleted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const generateRandomWord = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GamePage.useCallback[generateRandomWord]": (level)=>{
            const words = WORDS_BY_LEVEL[level.id] || WORDS_BY_LEVEL[1];
            const randomIndex = Math.floor(Math.random() * words.length);
            return words[randomIndex];
        }
    }["GamePage.useCallback[generateRandomWord]"], []);
    // Iniciar juego
    const startGame = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GamePage.useCallback[startGame]": (level)=>{
            ...
            timerRef.current = setInterval({
                "GamePage.useCallback[startGame]": ()=>{
                    setTimeLeft({
                        "GamePage.useCallback[startGame]": (prev)=>{
                            if (prev <= 1) {
                                // Tiempo agotado
                                setLives({
                                    "GamePage.useCallback[startGame]": (prevLives)=>{
            ...
            }["GamePage.useCallback[startGame]"], 1000);
        }
    }["GamePage.useCallback[startGame]"], [
        generateRandomWord
    ]);
    // Verificar palabra
    const checkWord = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GamePage.useCallback[checkWord]": ()=>{
            ...
            if (isCorrect) {
                ...
                setScore({
                    "GamePage.useCallback[checkWord]": (prev)=>prev + points
                }["GamePage.useCallback[checkWord]"]);
                setWordsCompleted({
                    "GamePage.useCallback[checkWord]": (prev)=>prev + 1
                }["GamePage.useCallback[checkWord]"]);
                setStreak({
                    "GamePage.useCallback[checkWord]": (prev)=>prev + 1
                }["GamePage.useCallback[checkWord]"]);
                ...
                // Palabra incorrecta
                setLives({
                    "GamePage.useCallback[checkWord]": (prev)=>{
    ...
    const simulateRecognition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GamePage.useCallback[simulateRecognition]": ()=>{
            ...
            if (newConfidence > 0.8) {
                setUserInput({
                    "GamePage.useCallback[simulateRecognition]": (prev)=>prev + randomLetter
                }["GamePage.useCallback[simulateRecognition]"]);
            }
        }
    }["GamePage.useCallback[simulateRecognition]"], []);
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        level.unlocked && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(GamePage, "AzHqgshtcwXEe/WLL7vHQ5qprH8=");
_c = GamePage;
var _c;
...
//# sourceMappingURL=_3d000f8c._.js.map