...
"[project]/app/debug-auth/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const testAuth = async ()=>{
            try {
                ...
                const { data, error: dbError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('user_profiles').select('id').limit(1);
                if (dbError) {
                ...
                const { data: gameData, error: gameError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('game_attempts').select('id').limit(1);
                if (gameError) {
...
//# sourceMappingURL=app_debug-auth_page_tsx_99b8b8ca._.js.map